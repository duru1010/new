    ...
    {recoveryProducts.map((item, index) => (
      ...
      >
        ...
        <div className="p-8 flex flex-col min-h-[420px]">
          ...
          {/* BUTTON - Features the signature corporate gradient track */}
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-4xl md:text-6xl font-black tracking-tighter text-slate-900 dark:text-white mb-8">
                Data
                <span className="bg-gradient-to-r from-[#3b71ca] to-[#00b4ed] bg-clip-text text-transparent"> Recovery </span>
              </h2>
