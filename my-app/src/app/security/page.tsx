  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#020617] transition-colors duration-500">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          <motion.div 
            ...
            className="absolute -top-1/2 -right-1/4 w-[1000px] h-[1000px] bg-blue-500/20 rounded-full blur-[120px]"
          />
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              <motion.div 
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-cyan-400 text-xs font-bold uppercase tracking-widest mb-6"
              >
              ...
              >
                Softlink provides enterprise-grade CCTV solutions that blend AI technology with robust hardware to keep your family and business safe 24/7.
              </motion.p>
              ...
              >
                <button className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-bold shadow-xl shadow-blue-600/30 transition-all flex items-center gap-2">
            ...
            >
              ...
              <motion.div 
                ...
                className="absolute -bottom-6 -left-6 bg-white dark:bg-slate-900 p-6 rounded-3xl shadow-2xl border border-slate-100 dark:border-white/10 z-20"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-black text-slate-900 dark:text-white">Active Protection</p>
                  </div>
                </div>
              </motion.div>
            </motion.div>
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-900/30">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-20">
            ...
            <p className="text-slate-500">Industry-leading hardware paired with smart software analytics.</p>
          </div>
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <div className="bg-blue-600 dark:bg-indigo-600 rounded-[3.5rem] p-8 md:p-16 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
                ...
                <div className="space-y-8 mt-10">
                  <div className="flex gap-6">
                    ...
                    <div>
                      ...
                      <p className="opacity-70 text-sm">We analyze your property to identify blind spots.</p>
                    </div>
                  </div>
                  <div className="flex gap-6">
                    ...
                    <div>
                      ...
                      <p className="opacity-70 text-sm">We select the right cameras and NVR architecture.</p>
                    </div>
                  </div>
                  <div className="flex gap-6">
                    ...
                    <div>
                      ...
                      <p className="opacity-70 text-sm">Clean wiring and mobile configuration by experts.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:w-1/3 bg-white/10 backdrop-blur-xl rounded-[2.5rem] p-8 border border-white/20">
                ...
                <p className="text-center opacity-80 text-sm mb-8">Get an estimate for your security needs.</p>
                <form className="space-y-4">
                  ...
                  <button className="w-full bg-white text-blue-600 font-bold py-4 rounded-xl hover:bg-blue-50 transition-colors">Submit Request</button>
                </form>
              </div>
            </div>
          </div>
