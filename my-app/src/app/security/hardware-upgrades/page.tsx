    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 overflow-hidden">
      ...
      <section className="relative pt-24 pb-16 lg:pt-28 lg:pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <Link
            href="/security"
            className="inline-flex items-center gap-2bg-gradient-to-r from-[#3b71ca] to-[#00b4ed] bg-clip-text text-transparent font-bold mb-8"
          >
            <ArrowLeft size={18} />
            Back To Services
          </Link>
...
>
  ...
  <div className="flex flex-col md:flex-row md:items-center md:justify-between border-b border-[#3b71ca]/10 pb-6 mb-10">
    ...
    {/* Header Badge - Styled with Softlink light blue background tint */}
    ...
    {upgradeProducts.map((item, index) => (
      ...
      >
        ...
        <div className="relative h-[260px] overflow-hidden">
              ...
              <span
                className={`text-[10px] font-black uppercase tracking-wider px-3 py-1 rounded-full text-white shadow-lg ${
                  item.tag === "Trending"
                    ...
                    : "bg-[#1a3a78]" // Darker brand accent shade
                }`}
              >
                {item.tag}
              </span>
          ...
          {/* PRICE BADGE - Updated text to Logo Blue */}
        ...
        <div className="p-8 flex flex-col min-h-[420px]">
          {/* TITLE - Hover color updated to Logo Blue */}
          ...
          {/* RATINGS - Updated to Logo Blue background */}
          ...
          <div className="mb-6">
            ...
            <div className="mt-4 flex items-center gap-2 flex-wrap">
              ...
              {item.badge && (
                // Secondary badge updated with Softlink Blue theme tints
          ...
          {/* SPECS - CheckCircle2 color shifted to Logo Cyan */}
          ...
          {/* BUTTON - Refactored to feature the signature corporate gradient track */}
    ...
    <div className="grid lg:grid-cols-2 gap-20 items-center">
      ...
      <div>
        <h3 className="text-4xl md:text-6xl font-black tracking-tighter text-slate-900 dark:text-white mb-8 leading-tight">
          Hardware
          <span className="bg-gradient-to-r from-[#3b71ca] to-[#00b4ed] bg-clip-text text-transparent"> Upgrade </span>
        </h3>
