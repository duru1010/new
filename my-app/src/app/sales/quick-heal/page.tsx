                                             ...
                                             />
                                                         ...
                                                         <div className="space-y-6">
                                                           ...
                                                           >
                                                             ...
                                                             <option>Bitdefender Total Security</option>
                                                             <option>Bitdefender Antivirus</option>
                                                             <option>Bitdefender Internet Security</option>
                                                             <option>Bitdefender Endpoint Security</option>
                                                           </select>
                                                         </div>
                                                       </div>
