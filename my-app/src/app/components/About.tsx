...
import { ShieldCheck, Target, Eye, Award, Moon, Sun, UserCheck, HardDrive } from 'lucide-react';
...
const About = () => {
  ...
  return (
    <section id="about" className="py-24 relative overflow-hidden bg-white dark:bg-slate-950 transition-colors duration-700">
      
      

      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none opacity-[0.03] dark:opacity-[0.05] select-none text-slate-900 dark:text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              Owned and operated by <strong className="text-indigo-600 dark:text-indigo-400 font-bold">Nagesh Salunke</strong>, 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <motion.div whileHover={{ y: -5 }} className="flex gap-4 p-8 rounded-[2.5rem] bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-white/5">
                <div className="text-indigo-600"><Target size={32} /></div>
                <div>
              ...
              <motion.div whileHover={{ y: -5 }} className="flex gap-4 p-8 rounded-[2.5rem] bg-indigo-600 dark:bg-indigo-700 border border-white/5">
                <div className="text-white"><HardDrive size={32} /></div>
                <div>
                  <h4 className="font-bold text-white text-lg">Our Edge</h4>
                  <p className="text-sm text-indigo-100 dark:text-indigo-50">Comprehensive networking solutions tailored for Pune's growing businesses.</p>
                </div>
              </motion.div>
            </div>
          ...
          <div className="lg:col-span-5 relative">
            ...
            >
              ...
              <div className="absolute bottom-8 left-8 right-8 p-6 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-indigo-600 rounded-full flex items-center justify-center text-white shadow-xl">
                    <UserCheck size={24} />
                  </div>
                  <div>
            ...
            <motion.div 
              ...
              className="absolute -top-6 -right-6 md:right-0 p-8 bg-indigo-600 rounded-[2.5rem] shadow-2xl text-white z-20"
            >
