...
//         setShowForm(false);
//         setFormData({ fullName: '', service: 'CCTV & Security', message: '' });
//       } else {
//         throw new Error();
//       }
//     } catch (err) {
...
//                     className="w-full pl-12 pr-4 py-3 rounded-2xl bg-slate-50 dark:bg-white/5 border dark:border-white/10 dark:text-white outline-none focus:ring-2 ring-[#25C1C5]" 
//                   />
//                 </div>
                
//                 <select 
//                   className="w-full px-4 py-3 rounded-2xl bg-slate-50 dark:bg-white/5 border dark:border-white/10 dark:text-white outline-none"
...
//                   className="w-full py-4 bg-[#25C1C5] hover:bg-[#1eb0b4] text-white rounded-2xl font-bold flex items-center justify-center gap-2 disabled:opacity-50"
//                 >
//                   {isSubmitting ? (
...
const Navbar = () => {
  ...
  // Form State - Updated to include mobile
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [formData, setFormData] = useState({
    fullName: '',
    mobile: '',
  ...
  return (
    <>
      ...
      {/* Form Modal - Updated with Mobile Field */}
      <AnimatePresence>
        {showForm && (
            <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={() => setShowForm(false)} className="absolute inset-0 bg-[#333333]/60 backdrop-blur-md" />
