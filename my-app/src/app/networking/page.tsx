          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-3/5 text-center lg:text-left">
              <motion.div 
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-cyan-400 text-xs font-black uppercase tracking-[0.2em] mb-6 border border-blue-100 dark:border-blue-500/20"
              >
              ...
              <motion.p 
                ...
                className="text-lg text-slate-500 dark:text-slate-400 mb-10 leading-relaxed max-w-2xl mx-auto lg:mx-0"
              >
                We build the backbone of your business. From high-speed fiber optics to secure firewalls, Softlink ensures your network never skips a beat.
              </motion.p>
              ...
              >
                <button className="px-10 py-5 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-black shadow-2xl shadow-blue-600/30 transition-all flex items-center gap-3 active:scale-95">
            ...
            >
              <div className="relative p-8 bg-slate-100 dark:bg-white/5 rounded-[3rem] border border-slate-200 dark:border-white/10 backdrop-blur-3xl overflow-hidden">
                <div className="flex flex-col gap-6">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="flex items-center gap-4 p-4 bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-100 dark:border-white/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {coreServices.map((service, index) => (
              <motion.div
                ...
                className="group relative bg-white dark:bg-slate-900 p-10 rounded-[2.5rem] border border-slate-100 dark:border-white/5 shadow-xl transition-all hover:border-blue-500/50"
              >
                ...
                <div className="h-1 w-0 group-hover:w-full bg-gradient-to-r from-blue-600 to-cyan-400 transition-all duration-500 rounded-full" />
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            <div className="lg:w-1/2">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="p-2 rounded-lg bg-blue-600"><Database size={20}/></div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="p-2 rounded-lg bg-indigo-600"><Cpu size={20}/></div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="p-2 rounded-lg bg-cyan-600"><Workflow size={20}/></div>
                  <div>
            ...
            <div className="lg:w-1/2 grid grid-cols-2 gap-4">
               ...
               <div className="aspect-square rounded-[2rem] bg-white/5 border border-white/10 flex flex-col items-center justify-center p-8 text-center">
                  <span className="text-5xl font-black text-blue-500">10G</span>
                  <span className="text-xs uppercase font-bold tracking-widest mt-2 opacity-60">Ready Speed</span>
               </div>
               <div className="aspect-square rounded-[2rem] bg-blue-600 flex flex-col items-center justify-center p-8 text-center">
      ...
      <section className="py-20 text-center">
        <div className="container mx-auto px-6">
          <motion.div 
            ...
            className="p-12 rounded-[3.5rem] bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/10 inline-block w-full max-w-4xl"
          >
            <h3 className="text-3xl font-black text-slate-900 dark:text-white mb-4">Need a Network Audit?</h3>
            <p className="text-slate-500 mb-8 max-w-lg mx-auto">Our experts will visit your site, analyze your current cabling, and provide a roadmap for 10G speeds.</p>
            <button className="px-12 py-5 bg-slate-900 dark:bg-blue-600 text-white rounded-2xl font-bold hover:shadow-2xl transition-all">
